<?php
    ...
    class Subject extends Db{
        ...
        function get_topics($id){
            ...
            $topic = $this->connect()->query("SELECT Topic,Topic_id from topic_tbl where Topic_id = '$teacher_id'");
